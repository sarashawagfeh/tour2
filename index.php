...
$conn = db_connect();
$__services_for_select = get_home_services($conn);
$destinations = get_destinations($conn);
?>
<?php
include('header.php');
?>
...
?>
  ...
  <div class="row mb-2">
    <div class="col-sm-12 col-md-6 mb-3 mb-lg-0 col-lg-4">
      <select name="dest_id" class="form-control custom-select" required>
    ...
    <div class="col-sm-12 col-md-6 mb-3 mb-lg-0 col-lg-5">
      <input type="text" class="form-control" name="daterange" placeholder="MM/DD/YYYY - MM/DD/YYYY">
    </div>

    <div class="col-sm-12 col-md-6 mb-3 mb-lg-0 col-lg-3">
      <input type="number" class="form-control" name="people" min="1" value="1" placeholder="# of People" required>
    </div>
  </div>
